...
| 3  | `03-catalogo.png`             | Catálogo con productos, buscador y filtros de categoría.              |
| 4  | `04-recomendados.png`         | Sección "Recomendado para ti" basada en categorías consultadas.       |
| 5  | `05-chatbot.png`              | Chatbot respondiendo una consulta + panel de **consultas recientes (LIFO)**. |
...
| 8  | `08-checkout.png`             | Pantalla de pago (simulado) con el método seleccionado.              |
...
| 12 | `12-panel-vendedor.png`       | Panel del vendedor publicando un producto (mensaje de éxito).        |
